...
public class GameResultTest {
    ...
    private void setPrivateBoard(TicTacToe game, Board board) {
        try {
            java.lang.reflect.Field field = TicTacToe.class.getDeclaredField("board");
    ...
    private void setPrivateCurrentPlayer(TicTacToe game, Player player) {
        try {
            java.lang.reflect.Field field = TicTacToe.class.getDeclaredField("currentPlayer");
            field.setAccessible(true);
